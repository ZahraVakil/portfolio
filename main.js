...
function scrollHeader(){
    const header = document.querySelectorId('header');
...
const downloadResumeLink = document.querySelector('.btn-download');

// Add a click event listener to the link
downloadResumeLink.addEventListener('click', (event) => {
    // Prevent the default action of the link (i.e., opening a new page)
